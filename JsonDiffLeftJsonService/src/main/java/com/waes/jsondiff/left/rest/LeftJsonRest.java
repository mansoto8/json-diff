...
/**
 * Controller that exposes the endpoint for the storing in database the left
...
public class LeftJsonRest {
	...
	/**
	 * Receives a base64 encoded json, decode it and store it in the database as the left part.
	 * 
